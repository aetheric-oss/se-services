...
- Autogenerated Rust Code
  - `protoc` for generating rust code from `.proto` files
  - `openapi-generator-cli` for generating rust code from OAS files
...
These logs are used by multiple services and tools.
